      ...
      <table className="w-full mt-2">
        <thead className="bg-blue-100">
          <tr className="border border-blue-300 p-1">
            <td className="border border-blue-300 p-1">Product Name</td>
            <td></td>
          </tr>
        </thead>
        <tbody>
          {products.map(product => (
            <tr className="border border-blue-300 p-1" key={product._id}>
              ...
              <td className="border border-blue-300 p-1 flex gap-2 justify-end">
                ...
                <Link href={'/products/delete/' + product._id} className="bg-blue-900 text-white text-sm py-1 px-2 rounded-md inline-flex items-center gap-1">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-4 h-4">
